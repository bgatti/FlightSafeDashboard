...
export const AIRPORT_COORDS = {
  ...
  KBDU: [40.04, -105.23], KBJC: [39.91, -105.12], KAPA: [39.57, -104.85],
  KCOS: [38.81, -104.70], KEGE: [39.64, -106.92], KGJT: [39.12, -108.53],
  KPUB: [38.29, -104.50], KGXY: [40.43, -104.63], KFTG: [39.79, -104.54],
  KTEX: [37.95, -107.91], KASE: [39.22, -106.87], KVYS: [41.35, -89.15],
}
